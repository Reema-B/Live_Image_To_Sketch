...
'''Turn a real time Image into a Live Sketch using Opencv in Python. OpenCV makes it very easy for us
to work with images and videos on the computer. 
We will also make use of Numpy and Matplotlib to make this Live Sketch App.'''
This is a temporary script file.
"""

#importing the OpenCV Library
import cv2
#importing the numpy library to work with Image Arrays
import numpy as np
...
def sketch(image):
    ...
    # Inter_area used for shrinking an image.
